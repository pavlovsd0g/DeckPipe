...
Уточнение пользователя от 14 сентября 2026: вход должен работать через любой системный браузер **без расширений**. Существующий Firefox-помощник и приведённые ниже команды его проверки относятся к прежней реализации, сохранённой для воспроизводимости. Не устанавливайте и не предлагайте его как решение текущего этапа B. Сборка с этим механизмом не соответствует обновлённой приёмке; статус и ограничения — в [плане релиза](docs/release-plan-2026-09-09.md).
