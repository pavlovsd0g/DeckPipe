...
try {
    ...
    $uiNameBugReport = New-DeckPipeUnicodeString -CodePoints @(0x041E, 0x0442, 0x043F, 0x0440, 0x0430, 0x0432, 0x0438, 0x0442, 0x044C, 0x20, 0x0431, 0x0430, 0x0433, 0x0440, 0x0435, 0x043F, 0x043E, 0x0440, 0x0442)
